...
import { Upload, ChevronRight, List, Database, FolderPlus, Info } from 'react-feather';
import { ReactComponent as OrgChartSVG } from '../assets/landing_page_image.svg';
import axios from 'axios';
import FileUploadModal from './FileUploadModal';
import TableSelectionModal from './TableSelectionModal';
import { ExistingDatabaseSection, NewDatabaseSection } from '../components/DatabaseSelection';
            ...
            <AnimatePresence mode="wait">
              ...
              {step === 'existing' && (
                <motion.div
                  ...
                  className="space-y-4"
                >
                  <ExistingDatabaseSection onUseExistingDB={handleUseExistingDB} />
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
