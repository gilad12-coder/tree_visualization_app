...
import { X, Keyboard, Navigation, MousePointer } from "lucide-react";
    ...
    >
      <div className="bg-white rounded-lg shadow-xl max-w-xl w-full overflow-hidden">
        ...
        <div className="flex justify-between items-center p-3 border-b border-gray-100">
          <h2 className="text-base font-medium text-gray-900">Keyboard Shortcuts</h2>
          <button
            onClick={onClose}
              ...
              <div className="space-y-0.5">
                {category.shortcuts.map((shortcut, index) => (
                  ...
                  >
                    ...
                    <kbd className="ml-3 px-2 py-0.5 bg-gray-50 border border-gray-200 rounded text-xs font-mono text-gray-600 whitespace-nowrap">
                      {shortcut.key}
                    </kbd>
                  </div>
                ))}
